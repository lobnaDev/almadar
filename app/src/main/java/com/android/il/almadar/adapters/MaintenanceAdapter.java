...
/**
 * Created by Labon on 5/1/2016.
 */
public class MaintenanceAdapter extends ArrayAdapter<UserService> {


    private Context context;
    private List<UserService> list;

    public MaintenanceAdapter(Context context, int resource, List<UserService> objects) {
