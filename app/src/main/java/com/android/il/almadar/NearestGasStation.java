...
import com.android.il.almadar.core.PlaceJSONParser;
...
public class NearestGasStation extends AppCompatActivity implements LocationListener {
      ...
      //  Button btnFind;
       ...
       // btnFind = ( Button ) findViewById(R.id.btn_find);
        ...
        if(status!=ConnectionResult.SUCCESS){ // Google Play Services are not available
            ...
            sb.append("&types="+type + "|petrol-station");
            sb.append("&sensor=true");
            sb.append("&key=AIzaSyDNu0-PQGbPEkQBwHLrYu_iMfogyUpaYVQ");//browser key
